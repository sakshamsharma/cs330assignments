...
ProcessAddrSpace::ProcessAddrSpace(OpenFile *_executable)
{
    NoffHeader noffH;
    unsigned int i, size;
    unsigned vpn, offset;
...
ProcessAddrSpace::ProcessAddrSpace(ProcessAddrSpace *parentSpace)
{
    ...
    executable = parentSpace->executable;
