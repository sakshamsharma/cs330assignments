...
//  PutThreadToSleep -- relinquish control over the CPU, but thread is now
//blocked.
...
void NachOSThread::AllocateThreadStack(VoidFunctionPtr func, int arg) {
...
void NachOSThread::ResetReturnValue() { userRegisters[2] = 0; }
#endif
...
void NachOSThread::Startup() { scheduler->Tail(); }
...
void NachOSThread::IncInstructionCount(void) { instructionCount++; }
