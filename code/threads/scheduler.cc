...
NachOSscheduler::~NachOSscheduler() { delete readyThreadList; }
...
void NachOSscheduler::ThreadIsReadyToRun(NachOSThread *thread) {
...
//      This is the portion of NachOSscheduler::Schedule after _SWITCH(). This
//      needs
